...
void check(void) {
    ...
    ASSERT_ALWAYS(f_z(z) == 0);
    ASSERT_ALWAYS(f_z(-z) == 0);
    ASSERT_ALWAYS(f_q(z) == 1);
    ASSERT_ALWAYS(f_q(-z) == 1);
    ASSERT_ALWAYS(f_q(q) == 1);
    ASSERT_ALWAYS(f_q(-q) == 1);
    ASSERT_ALWAYS(f_f(z) == 2);
    ASSERT_ALWAYS(f_f(-z) == 2);
    ASSERT_ALWAYS(f_f(q) == 2);
    ASSERT_ALWAYS(f_f(-q) == 2);
    ASSERT_ALWAYS(f_f(f) == 2);
    ASSERT_ALWAYS(f_f(-f) == 2);
    ASSERT_ALWAYS(f_zq(z) == 0);
    ASSERT_ALWAYS(f_zq(q) == 1);
    ASSERT_ALWAYS(f_zq(-q) == 1);
    ASSERT_ALWAYS(f_zf(z) == 0);
    ASSERT_ALWAYS(f_zf(f) == 2);
    ASSERT_ALWAYS(f_zf(-f) == 2);
    ASSERT_ALWAYS(f_qf(q) == 1);
    ASSERT_ALWAYS(f_qf(f) == 2);
    ASSERT_ALWAYS(f_qf(-f) == 2);
    ASSERT_ALWAYS(f_zqf(z) == 0);
    ASSERT_ALWAYS(f_zqf(q) == 1);
    ASSERT_ALWAYS(f_zqf(f) == 2);
    ASSERT_ALWAYS(f_zqf(-f) == 2);

    ASSERT_ALWAYS(f_zqf(mpz_class(z)) == 0);
    ASSERT_ALWAYS(f_zqf(mpz_class(-z)) == 0);
    ASSERT_ALWAYS(f_zqf(mpz_class(q)) == 0);
    ASSERT_ALWAYS(f_zqf(mpz_class(-q)) == 0);
    ASSERT_ALWAYS(f_zqf(mpz_class(f)) == 0);
    ASSERT_ALWAYS(f_zqf(mpz_class(-f)) == 0);
    ASSERT_ALWAYS(f_zqf(mpq_class(z)) == 1);
    ASSERT_ALWAYS(f_zqf(mpq_class(-z)) == 1);
    ASSERT_ALWAYS(f_zqf(mpq_class(q)) == 1);
    ASSERT_ALWAYS(f_zqf(mpq_class(-q)) == 1);
    ASSERT_ALWAYS(f_zqf(mpq_class(f)) == 1);
    ASSERT_ALWAYS(f_zqf(mpq_class(-f)) == 1);
    ASSERT_ALWAYS(f_zqf(mpf_class(z)) == 2);
    ASSERT_ALWAYS(f_zqf(mpf_class(-z)) == 2);
    ASSERT_ALWAYS(f_zqf(mpf_class(q)) == 2);
    ASSERT_ALWAYS(f_zqf(mpf_class(-q)) == 2);
    ASSERT_ALWAYS(f_zqf(mpf_class(f)) == 2);
    ASSERT_ALWAYS(f_zqf(mpf_class(-f)) == 2);
}
