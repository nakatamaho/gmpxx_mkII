...
void check_mpf(void) {
    ...
    }
    {
        const char *a = "777777";
        int prec = 64, base = 8;
        mpf_class b(a, prec, base);
        ASSERT_ALWAYS(b == 262143L);
    }
