...
| Examples | Present | Four CMake-built examples demonstrate basic mpf arithmetic, `sqrt`, Newton iteration for `sqrt(2)`, and Gauss-Legendre iteration for `pi` using the v2.0.0 wrapper precision policy. |
