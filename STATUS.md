...
| `test_mpz_arithmetic` | Present | mpz arithmetic, scalar mixing, truncating integer division, `%=` modulo, shift and compound-shift operators, scalar-mixed bitwise and complement operators, ET composition, self-alias, compound assignment, unary operators, exact integer helpers, static helper compatibility forms, helper exception policy, and negative Fibonacci semantics. |
