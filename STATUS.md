...
| `test_mpfc_transcendent_functions` | Present | `gmpxx::mpfc_class` complex `sqrt`, `exp`, `log`, trigonometric, inverse trigonometric, hyperbolic, inverse hyperbolic functions, integer/real/complex `pow`, expression inputs, real-axis cases, and principal square-root behavior. |
