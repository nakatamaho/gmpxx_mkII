...
$(OBJECTS_ORIG): $(SOURCES) $(HEADERS)
	$(CXX) $(CXXFLAGS) $(INCLUDES) -D___GMPXX_POSSIBLE_BUGS___ -D___GMPXX_STRICT_COMPATIBILITY___ -c $(SOURCES) -o $@
...
$(ORIG_TESTS): $(ORIG_TESTS_SOURCES) $(HEADERS)
	...
	$(CXX) $(CXXFLAGS) $(INCLUDES) -D___GMPXX_POSSIBLE_BUGS___ -D___GMPXX_STRICT_COMPATIBILITY___ -o $@ $< $(LDFLAGS)
