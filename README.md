...
transform, illustrating conditional convergence in Coulomb sums. `example15`
samples the SIAM 100-Digit Challenge cubic approximation problem for
`1/Gamma(z)` on the complex unit disk using `mpfc_class`.
